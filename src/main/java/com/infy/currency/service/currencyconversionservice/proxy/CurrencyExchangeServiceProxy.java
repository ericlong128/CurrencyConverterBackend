 ...
 * ="http://localhost:8001/currencyservice/from/USD/to/INR") public interface
 * CurrencyExchangeServiceProxy {
 * 
 * @GetMapping("/currencyservice/from/{from}/to/{to}") public
 * CurrencyConversionBean getCurrencyExchangeRate(@PathVariable String from,
 * 
